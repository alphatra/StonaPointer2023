...
export function Menu() {
    ...
    let menuItemStyles = "transition-all duration-300 mt-0 mr-2.5 pt-2.5 pb-2.5 pr-5 pl-5 text-center rounded-3xl text-black border border-gray-300 border-solid cursor-pointer font-satoshiVariable";
